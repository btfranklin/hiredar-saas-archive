...
class XMLErrorReportingTests(SimpleTestCase):
  ...
  <skills>
    ...
    @patch("apps.candidates.services.resume_processing.xml_error_reporting.logger")
    ...
    @patch("apps.candidates.services.resume_processing.xml_error_reporting.logger.info")
