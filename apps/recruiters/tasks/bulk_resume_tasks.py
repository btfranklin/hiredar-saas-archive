...
def unpack_and_process_zip(bulk_pk: int) -> dict[str, Any]:
    ...
    try:
        # Create an UploadedResumePool to own the JobSeekerProfiles that will be
        ...
        resume_pool = UploadedResumePool.objects.create(
            recruiter=bulk.recruiter.user,  # UploadedResumePool expects a User
            name=bulk.name,
        )
        ...
        with zipfile.ZipFile(io.BytesIO(data)) as zf:
            ...
            for name in names:
                ...
                # UploadedResumePool above, and generate a TalentSheet. The
