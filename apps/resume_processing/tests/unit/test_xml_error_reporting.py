...
class XMLErrorReportingTests(SimpleTestCase):
  ...
  <skills>
    ...
    @patch(
        "apps.resume_processing.services.resume_processing.xml_error_reporting.logger"
    )
    ...
    @patch(
        "apps.resume_processing.services.resume_processing.xml_error_reporting.logger.info"
    )
