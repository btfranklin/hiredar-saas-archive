...
CANDIDATE_RESUME_PROCESSING_MODEL = os.getenv(
    "CANDIDATE_RESUME_PROCESSING_MODEL", "gpt-5"
)
CANDIDATE_RESUME_PROCESSING_REASONING_EFFORT = os.getenv(
    "CANDIDATE_RESUME_PROCESSING_REASONING_EFFORT", "minimal"
)

# Candidate Role Recommendations
CANDIDATE_ROLE_RECOMMENDATION_MODEL = os.getenv(
    "CANDIDATE_ROLE_RECOMMENDATION_MODEL", "gpt-5"
)
CANDIDATE_ROLE_RECOMMENDATION_REASONING_EFFORT = os.getenv(
    "CANDIDATE_ROLE_RECOMMENDATION_REASONING_EFFORT", "medium"
)

# Candidate Tagline Generation
CANDIDATE_TAGLINE_GENERATION_MODEL = os.getenv(
    "CANDIDATE_TAGLINE_GENERATION_MODEL", "gpt-5"
)
CANDIDATE_TAGLINE_GENERATION_REASONING_EFFORT = os.getenv(
    "CANDIDATE_TAGLINE_GENERATION_REASONING_EFFORT", "minimal"
)
CANDIDATE_TAGLINE_MAX_ATTEMPTS = int(os.getenv("CANDIDATE_TAGLINE_MAX_ATTEMPTS", "3"))

# Candidate Talent Sheet Generation
CANDIDATE_TALENT_SHEET_MODEL = os.getenv("CANDIDATE_TALENT_SHEET_MODEL", "gpt-5")
CANDIDATE_TALENT_SHEET_REASONING_EFFORT = os.getenv(
    "CANDIDATE_TALENT_SHEET_REASONING_EFFORT", "low"
)
...
CANDIDATE_TAGLINE_MAX_TOKENS = int(os.getenv("CANDIDATE_TAGLINE_MAX_TOKENS", "50"))
