...
JOBSEEKERS_TAGLINE_GENERATION_MODEL = os.getenv(
    "JOBSEEKERS_TAGLINE_GENERATION_MODEL", "gpt-5-mini"
)
...
MATCHING_ANALYSIS_MODEL = os.getenv("MATCHING_ANALYSIS_MODEL", "gpt-5-mini")
MATCHING_ANALYSIS_REASONING_EFFORT = os.getenv(
    "MATCHING_ANALYSIS_REASONING_EFFORT", "medium"
)

# AI Model Configuration (Tokens, Reasoning, etc.)
...
JOBSEEKERS_RECOMMENDATION_REASONING_EFFORT = os.getenv(
    "JOBSEEKERS_RECOMMENDATION_REASONING_EFFORT", "medium"
)
JOBSEEKERS_TAGLINE_MAX_TOKENS = int(os.getenv("JOBSEEKERS_TAGLINE_MAX_TOKENS", "50"))
JOBSEEKERS_TAGLINE_REASONING_EFFORT = os.getenv(
    "JOBSEEKERS_TAGLINE_REASONING_EFFORT", "minimal"
)
JOBSEEKERS_TALENT_SHEET_REASONING_EFFORT = os.getenv(
    "JOBSEEKERS_TALENT_SHEET_REASONING_EFFORT", "medium"
)
