...
JOBSEEKERS_WORKSHOP_MODEL = os.getenv("JOBSEEKERS_WORKSHOP_MODEL", "gpt-4.1")
JOBSEEKERS_WORKSHOP_TEMPERATURE = float(
    os.getenv("JOBSEEKERS_WORKSHOP_TEMPERATURE", "0.7")
)
# Job Seeker Workshop (tool-specific) settings
JOBSEEKERS_WORKSHOP_UPGRADE_MODEL = os.getenv(
    "JOBSEEKERS_WORKSHOP_UPGRADE_MODEL", "gpt-4.1"
)
JOBSEEKERS_WORKSHOP_UPGRADE_TEMPERATURE = float(
    os.getenv("JOBSEEKERS_WORKSHOP_UPGRADE_TEMPERATURE", "0.7")
)
JOBSEEKERS_WORKSHOP_DAILY_LIMIT = int(
    os.getenv("JOBSEEKERS_WORKSHOP_DAILY_LIMIT", "10")
)

JOBSEEKERS_WORKSHOP_TARGETED_MODEL = os.getenv(
    "JOBSEEKERS_WORKSHOP_TARGETED_MODEL", "gpt-4.1"
)
JOBSEEKERS_WORKSHOP_TARGETED_TEMPERATURE = float(
    os.getenv("JOBSEEKERS_WORKSHOP_TARGETED_TEMPERATURE", "0.7")
)
