...
# LinkedIn optimization tool (same defaults)
JOBSEEKERS_WORKSHOP_LINKEDIN_MODEL = os.getenv(
    "JOBSEEKERS_WORKSHOP_LINKEDIN_MODEL", "gpt-4.1"
)
JOBSEEKERS_WORKSHOP_LINKEDIN_TEMPERATURE = float(
    os.getenv("JOBSEEKERS_WORKSHOP_LINKEDIN_TEMPERATURE", "0.7")
)
